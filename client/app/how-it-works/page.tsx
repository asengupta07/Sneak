...
import { ArrowRight, Shield, Eye, Users, TrendingUp, Lock, Zap, Target, DollarSign, Clock, CheckCircle, BookOpen, FileText, Database, Network, Cpu, Layers, GitBranch, BarChart3, AlertTriangle, Info } from "lucide-react"
...
export default function HowItWorksPage() {
    ...
    const sections = [
        ...
        { id: 'mechanism', title: 'Mechanism Design', icon: Zap },
        { id: 'privacy', title: 'Privacy Architecture', icon: Lock },
        { id: 'implementation', title: 'Implementation', icon: Cpu },
        { id: 'security', title: 'Security Analysis', icon: Shield },
        { id: 'economics', title: 'Economic Model', icon: BarChart3 },
        { id: 'challenges', title: 'Challenges & Mitigations', icon: AlertTriangle },
    ...
    const tableOfContents = [
        ...
        { id: 'private-pricing', title: 'Private Pricing Mechanism', level: 2 },
        ...
        { id: 'client-side-privacy', title: 'Client-Side Privacy', level: 2 },
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            {/* Navigation */}
            <Navbar variant="technical" currentPage="#abstract" />
            ...
            <section id="abstract" className="pt-32 pb-20 px-6 lg:ml-80">
                <div className="max-w-5xl mx-auto">
                    <div className="inline-flex items-center bg-orange-500/10 border border-orange-500/20 rounded-full px-6 py-2 mb-8">
                        ...
                        <span className="text-orange-500 font-medium">Technical Whitepaper v1.0</span>
                    </div>
                    ...
                    <div className="bg-gray-900/50 border border-orange-500/20 rounded-2xl p-8 mb-12">
                        ...
                        <p className="text-lg text-gray-300 leading-relaxed mb-6">
                            <strong>Sneak</strong> introduces a novel mechanism for <strong>private opportunity markets</strong> that enables
            ...
            <section id="mechanism" className="py-20 px-6 lg:ml-80">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="space-y-12">
                        ...
                        <div>
                            <h3 id="liquidity-provision" className="text-2xl font-semibold text-white mb-6">2.4 Liquidity Provision</h3>
                            <p className="text-lg text-gray-300 leading-relaxed mb-6">
                                Sponsors provide liquidity through <strong>automated market makers (AMMs)</strong> or
                                <strong>order book mechanisms</strong>, with liquidity concentrated in probability ranges
                                that align with their risk tolerance and discovery objectives.
                            </p>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full border border-orange-500/20 rounded-lg">
                                    <thead className="bg-orange-500/10">
                                        <tr>
                                            <th className="px-4 py-3 text-left text-orange-500 font-semibold">Liquidity Model</th>
                                            <th className="px-4 py-3 text-left text-orange-500 font-semibold">Concentration Range</th>
                                            <th className="px-4 py-3 text-left text-orange-500 font-semibold">Risk Profile</th>
                                            <th className="px-4 py-3 text-left text-orange-500 font-semibold">Use Case</th>
                                        </tr>
                                    </thead>
                                    <tbody className="text-gray-300">
                                        <tr className="border-t border-orange-500/20">
                                            <td className="px-4 py-3"><strong>Conservative</strong></td>
                                            <td className="px-4 py-3">1-10% probability</td>
                                            <td className="px-4 py-3">Low risk, high conviction</td>
                                            <td className="px-4 py-3">Established artists, proven research</td>
                                        </tr>
                                        <tr className="border-t border-orange-500/20">
                                            <td className="px-4 py-3"><strong>Moderate</strong></td>
                                            <td className="px-4 py-3">5-30% probability</td>
                                            <td className="px-4 py-3">Medium risk, emerging opportunities</td>
                                            <td className="px-4 py-3">Rising artists, breakthrough research</td>
                                        </tr>
                                        <tr className="border-t border-orange-500/20">
                                            <td className="px-4 py-3"><strong>Aggressive</strong></td>
                                            <td className="px-4 py-3">10-50% probability</td>
                                            <td className="px-4 py-3">High risk, early discovery</td>
                                            <td className="px-4 py-3">Undiscovered talent, experimental research</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
            ...
            <section id="privacy" className="py-20 px-6 lg:ml-80">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="space-y-12">
                        <div>
                            <h3 id="private-pricing" className="text-2xl font-semibold text-white mb-6">3.1 Private Pricing Mechanism</h3>
                            <p className="text-lg text-gray-300 leading-relaxed mb-6">
                                The <strong>private pricing mechanism</strong> is the cornerstone of Sneak's competitive advantage.
                                Unlike traditional prediction markets where prices are public, Sneak ensures that only the
                                <strong>sponsor (liquidity provider)</strong> can observe real-time market prices and order flow.
                                This prevents competitors from free-riding on discovery signals while maintaining market efficiency.
                            </p>

                            <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-6 mb-6">
                                <h4 className="text-lg font-semibold text-purple-400 mb-4">Privacy Guarantees</h4>
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        <h5 className="font-semibold text-white mb-3">Information Asymmetry</h5>
                                        <ul className="space-y-2 text-gray-300 text-sm">
                                            <li>• <strong>Price Privacy:</strong> Only sponsors see current market prices</li>
                                            <li>• <strong>Order Flow Privacy:</strong> Trading patterns remain confidential</li>
                                            <li>• <strong>Position Privacy:</strong> Individual bet sizes are hidden</li>
                                            <li>• <strong>Identity Privacy:</strong> Scout identities are pseudonymous</li>
                                        </ul>
                                    </div>
                                    <div>
                                        <h5 className="font-semibold text-white mb-3">Temporal Privacy</h5>
                                        <ul className="space-y-2 text-gray-300 text-sm">
                                            <li>• <strong>Delayed Settlement:</strong> 2-week opportunity window</li>
                                            <li>• <strong>Batch Processing:</strong> Orders processed in batches</li>
                                            <li>• <strong>Randomized Timing:</strong> Settlement times vary</li>
                                            <li>• <strong>Retroactive Transparency:</strong> Post-resolution disclosure</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <h3 id="eerc-implementation" className="text-2xl font-semibold text-white mb-6">3.2 eERC Implementation</h3>
                            <p className="text-lg text-gray-300 leading-relaxed mb-6">
                        ...
                        <div>
                            <h3 id="confidential-transactions" className="text-2xl font-semibold text-white mb-6">3.3 Confidential Transactions</h3>
                            <p className="text-lg text-gray-300 leading-relaxed mb-6">
            ...
            <section id="implementation" className="py-20 px-6 lg:ml-80">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="space-y-12">
                        ...
                        <div>
                            <h3 id="client-side-privacy" className="text-2xl font-semibold text-white mb-6">4.3 Client-Side Privacy</h3>
                            <p className="text-lg text-gray-300 leading-relaxed mb-6">
                                The client-side privacy implementation ensures that <strong>all encryption and decryption</strong>
                                operations occur locally on the user's device. This eliminates the need for trusted third parties
                                and provides <strong>end-to-end privacy</strong> for all trading activities.
                            </p>

                            <div className="bg-green-900/20 border border-green-500/30 rounded-lg p-6">
                                <h4 className="text-lg font-semibold text-green-400 mb-4">Client Architecture</h4>
                                <div className="space-y-4">
                                    <div className="flex items-start space-x-3">
                                        <Cpu className="w-5 h-5 text-green-400 mt-1" />
                                        <div>
                                            <h5 className="font-semibold text-white">Local Encryption</h5>
                                            <p className="text-gray-300 text-sm">All sensitive data encrypted before leaving the client</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <Layers className="w-5 h-5 text-green-400 mt-1" />
                                        <div>
                                            <h5 className="font-semibold text-white">Zero-Knowledge Proofs</h5>
                                            <p className="text-gray-300 text-sm">Proof generation happens locally using WebAssembly</p>
                                        </div>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <GitBranch className="w-5 h-5 text-green-400 mt-1" />
                                        <div>
                                            <h5 className="font-semibold text-white">Key Management</h5>
                                            <p className="text-gray-300 text-sm">HD wallet integration with hardware wallet support</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="challenges" className="py-20 px-6 lg:ml-80">
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-4xl font-bold text-orange-500 mb-8">7. Challenges & Mitigations</h2>

                    <div className="space-y-12">
                        <div>
                            <h3 id="regulatory-considerations" className="text-2xl font-semibold text-white mb-6">7.1 Regulatory Considerations</h3>
                            <p className="text-lg text-gray-300 leading-relaxed mb-6">
                        ...
                        <div>
                            <h3 id="technical-challenges" className="text-2xl font-semibold text-white mb-6">7.2 Technical Challenges</h3>
                            <p className="text-lg text-gray-300 leading-relaxed mb-6">
            ...
            <section id="conclusion" className="py-20 px-6 lg:ml-80">
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-4xl font-bold text-orange-500 mb-8">8. Conclusion</h2>
            ...
            <section id="references" className="py-20 px-6 lg:ml-80">
                <div className="max-w-5xl mx-auto">
                    <h2 className="text-4xl font-bold text-orange-500 mb-8">9. References</h2>
            ...
            <section className="py-20 px-6 bg-gradient-to-r from-orange-500/10 to-orange-500/5 lg:ml-80">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-4xl font-bold mb-6 text-orange-500">Ready to Start Scouting?</h2>
            ...
            {/* Footer */}
            <footer className="py-12 px-6 border-t border-gray-800 lg:ml-80">
                <div className="max-w-6xl mx-auto text-center">
                    <div className="text-2xl font-serif italic text-orange-500 mb-4">Sneak</div>
                    <p className="text-gray-400">Private Opportunity Markets on Avalanche</p>
                    <p className="text-gray-500 text-sm mt-2">Technical Whitepaper v1.0 - © 2024 Sneak Protocol</p>
                </div>
            </footer>
        </div>
    )
